...
install -m 0755 "$PKG_SRC/usr/bin/farsight-setup-desktop" "$ROOT/usr/bin/farsight-setup-desktop"
install -m 0755 "$PKG_SRC/usr/lib/farsight/x11-welcome.sh" "$ROOT/usr/lib/farsight/x11-welcome.sh"
